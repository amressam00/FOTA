...
//
//	/* Get Address */
//	DataDigit0 = AsciToHex (Copy_u8BufData[3]);//9
//	DataDigit1 = AsciToHex (Copy_u8BufData[4]);//10
//	DataDigit2 = AsciToHex (Copy_u8BufData[5]);//11
//	DataDigit3 = AsciToHex (Copy_u8BufData[6]);//12
//
//	/* Clear Low Part of Address */
